...
<html>
	...
	<head>
        ...
        <script>
            $(function () {
                $.ajax({
                    url:"productServlet?method=findHotProduct",
                    type:"get",
                    dataType:"json",
                    success:function (data) {
                        $(data).each(function (i) {
                            var product=data[i];
                            if(i==0){
                                $("#hot").append("<div class=\"col-md-6\" style=\"text-align:center;height:200px;padding:0px;\">\n" +
                                    "\t\t\t\t\t\t<a href=\"product_info.jsp\">\n" +
                                    "\t\t\t\t\t\t\t<img src=\""+product.pimage+"\" width=\"516px\" height=\"200px\" style=\"display: inline-block;\">\n" +
                                    "\t\t\t\t\t\t</a>\n" +
                                    "\t\t\t\t\t</div>");
                            }else {
