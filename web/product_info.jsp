		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					...
					<a href="product_list.jsp"><c:if test="${product.cid==1}">手机数码</c:if><c:if test="${product.cid==2}">电脑办公</c:if>&nbsp;&nbsp;&gt;</a>
					<a>${product.pname}</a>
				</div>
								...
								<script>
									$(function () {
										$("#quantity").blur(function () {
											...
											var href="cartServlet?method=addCart&num="+num;
											$("#addcart").attr("href",href);
										});
									})
								</script>
								<a href="cartServlet?method=addCart&num=1" id="addcart">
